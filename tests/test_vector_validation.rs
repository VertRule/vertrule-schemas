...
vr_test!(
    ...
    fn digest_bytes_reject_short_001() {
...
vr_test!(
    ...
    fn digest_bytes_reject_chars_001() {
...
vr_test!(
    ...
    fn jcs_reject_duplicate_key_001() {
...
vr_test!(
    ...
    fn jcs_reject_noncharacter_001() {
...
vr_test!(
    ...
    fn envelope_reject_missing_field_001() {
